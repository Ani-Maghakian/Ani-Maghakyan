export const books = [
  {
    ...
    descriptions: {
      hy: 'Անի Մաղաքյանի պատմվածքների ժողովածուն՝ հրատարակված 2010 թվականին Երևանում, «Վան Արյան» հրատարակչության կողմից։ Հայերեն գիրքն ունի 172 էջ՝ ըստ ԱՄՆ Կոնգրեսի գրադարանի կատալոգի։',
      en: 'Ani Maghakyan’s short-story collection, published by Van Aryan in Yerevan in 2010. The Armenian-language book has 172 pages, according to the Library of Congress catalogue.',
      ru: 'Сборник рассказов Ани Магакян, выпущенный издательством «Ван Арьян» в Ереване в 2010 году. По каталогу Библиотеки Конгресса, книга на армянском языке насчитывает 172 страницы.',
    },
