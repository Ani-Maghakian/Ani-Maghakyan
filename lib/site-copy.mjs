...
export const homeHero = {
  hy: {
    ...
    tagline: 'Սցենարագրություն, պատմության մշակում, շոուռանինգ և ստեղծագործական պրոդյուսինգ։',
    intro: 'Maghakian Scripts՝ Անի Մաղաքյանի հիմնադրած սցենարական ստուդիա։',
    founderRole: 'Հիմնադիր և ստեղծագործական ղեկավար',
    start: 'Սկսել նախագիծ',
  },
  en: {
    heading: 'The story starts here.',
    tagline: 'Screenwriting, story development, showrunning and creative production.',
    intro: 'Maghakian Scripts is a screenwriting studio founded by Ani Maghakyan.',
    founderRole: 'Founder & Creative Lead',
    start: 'Start a Project',
  },
  ru: {
    heading: 'История начинается здесь.',
    tagline: 'Сценарии, разработка историй, шоураннинг и творческое продюсирование.',
    intro: 'Maghakian Scripts — сценарная студия, основанная Ани Магакян.',
