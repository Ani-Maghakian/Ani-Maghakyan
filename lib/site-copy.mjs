export const updatedIso = "2026-09-17";

// Content dates, not build dates. Project descriptions and links changed September 17.
...
const armenianHeroLines = ['Անի Մաղաքյան — գրող, սցենարիստ,', 'շոուռաներ և պրոդյուսեր'];

export const homeHero = {
  hy: { heading: armenianHeroLines.join(' '), lines: armenianHeroLines, tagline: 'Պատմություններ, որոնք կյանք են առնում էկրանին։' },
  en: { heading: 'Ani Maghakyan — Screenwriter, Showrunner & Producer', tagline: 'Stories built to live on screen.' },
  ru: { heading: 'Ани Магакян — сценарист, шоураннер и продюсер', tagline: 'Истории, созданные для экрана.' },
};
...
export const sectionLinks = [
  ...
  { slug: 'work-with-ani', labels: { hy: 'Սկսել նախագիծ', en: 'Start a Project', ru: 'Начать проект' } },
];
