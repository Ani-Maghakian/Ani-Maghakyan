export const copy = {
  hy: {
    ...
    booksTitle: "Գրքեր",
    books: ["«Ժամանակավոր կանգառ» — պատմվածքների ժողովածու, 2010", "«Տակնուվրա» — պատմվածքներ և մենախոսություններ, 2024 թ. հրատարակություն"],
    ...
    faqs: [
      ...
      { q: "Որո՞նք են Անի Մաղաքյանի առանցքային նախագծերը։", a: "«Էլենի օրագիրը», «Թղթե երազանք», «Սիրելի Սահմի», «Հատուկ դասարան», «Կախվածություն», «84-ի ամառը», «Բլոկադա», «Կհանդիպենք անտառի տնակում», «Եթե ես կրկին պարեի», «Se.La.Vi», «Hotel Grand» և «Մի գեղեցիկ օր»։" },
    ...
    updated: "Թարմացված՝ 6 սեպտեմբերի, 2026",
    backTop: "Վերև",
  },
  en: {
    localeName: "English",
    ...
    booksTitle: "Books",
    books: ["Temporary Stop — short-story collection, 2010", "Taknuvra (Upside Down) — stories and monologues, 2024 edition"],
    sourcesKicker: "EVIDENCE / 04",
  ...
  ru: {
    ...
    booksTitle: "Книги",
    books: ["«Временная остановка» — сборник рассказов, 2010", "«Такнувра» («Вверх дном») — рассказы и монологи, издание 2024 года"],
    sourcesKicker: "EVIDENCE / 04",
...
export const sourceLinks = [
  ...
  },
  {
    ...
    note: { hy: "«84-ի ամառը» և «Էլենի օրագիրը» աշխատանքների հիշատակում", en: "Coverage of Summer of ’84 and Elen’s Diary", ru: "Упоминание «Лета ’84» и «Дневника Элен»" },
  },
  {
    id: 7,
    label: "Oragir News",
